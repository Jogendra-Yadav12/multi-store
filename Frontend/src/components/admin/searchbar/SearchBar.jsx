        ...
        <div className='flex gap-3 items-center justify-between w-full'>
            ...
            <div>
                <NavLink to='/admin/add-category'>
                    ...
                    <button className='bg-indigo-600 text-white px-2 py-2 rounded flex items-center gap-1'><AddIcon /> <span className='text-sm md:text-lg max-sm:hidden'>{path}</span></button>
                </NavLink>
