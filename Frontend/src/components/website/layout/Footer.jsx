...
const Footer = () => {
  return (
    ...
    <footer className="w-full bg-gradient-to-r text-left from-orange-50 via-[#aedbff] to-orange-200">
      <div className="px-2 py-8 mx-auto sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75"> Sell on SabMilega </a>
                <a className="hover:opacity-75">Advertise Your Products </a>
