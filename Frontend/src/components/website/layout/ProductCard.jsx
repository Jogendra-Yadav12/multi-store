...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    <div className=" bg-white w-64 text-left rounded-xl shadow-md border cursor-pointer overflow-hidden relative group hover:shadow-lg transition-all duration-300 hover:border-blue-400">
