                            ...
                            <div className='flex items-start text-left justify-start w-full gap-5 ' key={item.id}>
                                ...
                                <div className='w-36 flex items-center flex-col gap-2'>
                                    {
                                        imagesArray.map((img, index) => (
                                            <img
                                                ...
                                                key={index}
                                                alt={`product-${index}`}
                                                className='w-16 h-16 object-cover cursor-pointer border-blue-400 border p-1'
                                ...
                                <div className='w-full'>
                                    ...
                                    <div className='my-5 text-white flex items-center gap-3'>
                                        <span className='w-16 h-8 justify-center flex items-center bg-blue-600 rounded-full gap-1'>
                                            4.0 <StarIcon sx={{ fontSize: 16 }} />
                                        </span>
                                        <span className='text-gray-500'>4 ratings and 0 reviews</span>
                                    </div>
                                </div>
                            </div>
                        )
