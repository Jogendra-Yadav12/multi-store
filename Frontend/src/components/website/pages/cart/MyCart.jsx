                    ...
                    <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
...

                                {
                                    safeCartItems && cartItems.length === 0 ? (
                                        <div className='w-full h-100 flex flex-col text-center items-center justify-center'>
                                            ...
                                            <Link to="/" className='mt-5 border-2 border-blue-300  px-12 py-3 rounded text-gray-700 hover:bg-blue-300' >Go Shop Now</Link>
                                        </div>
                                    ) : (
                        ...
                        <div className="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                            <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-lg sm:p-6">
                                ...
                                <Link to="/checkout" className="flex w-full items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-primary-300">Proceed to Checkout</Link>
