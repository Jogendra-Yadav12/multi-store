    ...
    return (
        <div className='text-center'>
            ...
            <div className='p-5 w-full bg-indigo-50 text-left'>
                <div className='flex-row md:flex items-start gap-4'>
                    <div>
                            ...
                            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                                <div className="flex flex-row items-center w-full gap-6 xl:flex-row">
                                    ...
                                    <div className="order-3 xl:order-2">
                                        ...
                                        <h4 className="mb-2 text-lg font-semibold text-gray-800 xl:text-left">
                                            {user.f_name} {user.l_name}
                                        </h4>
                                        <div className="flex justify-start items-center gap-1 xl:flex-row xl:gap-3">
                                            <p className="text-sm text-gray-500 ">
                                                SabMilega
                                            </p>
                                            <div className="h-3.5 w-px bg-gray-300  xl:block"></div>
                                            <p className="text-sm text-gray-500">
                                                Customer
                                            </p>
                                        </div>
